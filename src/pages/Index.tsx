...
const Index = () => {
  ...
  const questions = [
    ...
    {
      id: 'past_fertilizers',
      question: 'Какими удобрениями вы пользовались ранее?',
      type: 'textarea',
      placeholder: 'Перечислите удобрения, которые использовали'
    },
    {
    ...
    },
    {
      ...
      question: 'Привело ли применение удобрений к повышению урожайности?',
      type: 'radio',
      options: ['Да, значительно повысилась', 'Да, немного повысилась', 'Нет изменений', 'Урожайность снизилась', 'Затрудняюсь ответить']
    },
    {
      id: 'yield_details',
      question: 'Расскажите подробнее о влиянии удобрений на вашу урожайность',
      type: 'textarea',
      placeholder: 'Опишите изменения урожайности, если были'
    },
    {
    ...
    },
    {
      ...
      question: 'Знаете ли вы, что такое сапропель?',
      type: 'radio',
      options: ['Да, знаю хорошо', 'Да, слышал(а)', 'Нет, не слышал(а)', 'Затрудняюсь ответить']
    },
    {
      id: 'sapropel_description',
      question: 'Если знаете, опишите своими словами, что такое сапропель',
      type: 'textarea',
      placeholder: 'Опишите, что вы знаете о сапропеле'
    },
    {
      id: 'sapropel_experience',
      question: 'Использовали ли вы когда-либо сапропель в своём хозяйстве?',
      type: 'radio',
      options: ['Да, использую регулярно', 'Да, пробовал(а)', 'Нет, но планирую', 'Нет, не использовал(а)']
    },
    {
      id: 'sapropel_experience_details',
      question: 'Если использовали сапропель, расскажите о результатах',
      type: 'textarea',
      placeholder: 'Опишите ваш опыт применения сапропеля'
    },
    {
      id: 'sapropel_willingness',
      question: 'Будете ли вы применять сапропель в качестве удобрения?',
      type: 'radio',
      options: ['Да, обязательно буду', 'Да, если увижу доказательства эффективности', 'Возможно, хотел(а) бы узнать больше', 'Скорее нет', 'Определённо нет']
    },
    {
    ...
    },
    {
      ...
      question: 'Какой способ доставки удобрений вам наиболее удобен?',
      type: 'radio',
      options: ['Самовывоз', 'Доставка до хозяйства', 'Железнодорожная доставка', 'Не имеет значения']
    },
    {
